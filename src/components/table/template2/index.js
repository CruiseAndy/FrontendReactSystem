...
const ReactTable = props => {
  ...
  const setNotificationData = data => {
	...
	return (
		<div className="table2_component">
      {
        detailInfo &&
			...
			<div className="table_box">
      {
        ...
        : props.data.map((dataItem, dataIndex) => {
            return (
              <div key={dataIndex} className="table_data_group">
              {
                props.structure.map((item, keyIndex) => {
                  if (item.key == "is_read") {
                    return (
                      <div key={dataIndex} className="notification_unread_box">
                      {
                        !dataItem[item.key] &&
                    ...
                    return (
                      <div key={keyIndex} className="table_img_box" onClick={() => {
                    ...
                    return (
                      <div key={keyIndex} className="table_data_box">
                        <p className="table_data_info_title">{item.title}</p>
                        <p className="table_data_info_txt">{dataItem[item.key]}</p>
                      </div>
                    );
                  }
                })
